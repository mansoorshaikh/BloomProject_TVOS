...
@synthesize appDelegate,activityIndicator,firstView,secondView,thirdView,fristBtn,secondBtn,thirdBtn,overlayView,isMenuVisible,menuNameArray,menuNameButton,navigationmenuBtn,navigationSearchBtn,bloomimg;
- (void)viewDidLoad {
    [super viewDidLoad];
