...
@interface ShortsViewController ()

@end

@implementation ShortsViewController
@synthesize activityIndicator,shortTableView,shortArray,appDelegate,overlayView,isMenuVisible,menuNameArray,menuNameButton,navigationmenuBtn,navigationSearchBtn,bloomimg;
- (void)viewDidLoad {
    [super viewDidLoad];
    ...
    shortArray=[[NSMutableArray alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TagCategoryDataVO *serVO=[shortArray objectAtIndex:indexPath.row];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TagCategoryDataVO *svo=[shortArray objectAtIndex:indexPath.row];
