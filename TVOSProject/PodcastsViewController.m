...
- (void)viewDidLoad {
    ...
    [self.view addSubview:navigationSearchBtn];       //SeriesTableView.backgroundColor=[UIColor blackColor];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TagCategoryDataVO *serVO=[podcastsArray objectAtIndex:indexPath.row];
